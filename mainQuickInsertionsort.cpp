...
//quicksort and medianOfThree came from class notes, insertionsort was modified from book code
void insertionsort(double* a, int begin, int end){
...
int main(){
	...
	cout << "It took " << t << " clicks to sort using QuickSort for n>=20 and InsertionSort for n<20." << endl;
